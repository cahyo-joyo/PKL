...
<div class="right_col" role="main">
    ...
    <main role="main" class="container-fluid">
        <h1 style="font-size: 23px;">Data Server</h1><br>
        <!-- FLASH DATA -->
        ...
        <?php if (session()->get('error')) : ?>
            <div class="alert alert-danger alert-dismissble fade show" role="alert">
                ...
                Database sudah ada! <strong <?= session()->getFlashData('error'); ?>></strong>
            </div>
        <?php endif ?>
        <?php if (session()->get('errors')) : ?>
            <div class="alert alert-danger alert-dismissble fade show" role="alert">
                ...
                Setup sudah ada! <strong <?= session()->getFlashData('errors'); ?>></strong>
            </div>
        <?php endif ?>
        <!-- FLASH DATA -->
